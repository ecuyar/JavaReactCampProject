...
public class ProductManager implements ProductService {
	...
	@Override
	public DataResult<Product> getByProductNameAndCategoryId(String productName, int id) {
		return new SuccessDataResult<Product>((this.productDao.getByProductNameAndCategoryId(productName, id)),
				"Data listelendi.");
	}

	@Override
	public DataResult<List<Product>> getByProductNameOrCategoryId(String productName, int id) {
		return new SuccessDataResult<List<Product>>((this.productDao.getByProductNameOrCategoryId(productName, id)),
				"Data listelendi.");
	}
